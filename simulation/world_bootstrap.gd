...
const PROVINCE_TABLE: Array[Array] = [
	...
	# --- Minor Clans ---
	["Fox Clan Lands", "Fox", "Kitsune", false, false, false],
	["Wasp Ashinagabachi", "Wasp", "Tsuruchi", false, false, false],
	["Wasp Enzan", "Wasp", "Tsuruchi", false, false, false],
	["Wasp Chuuhan", "Wasp", "Tsuruchi", false, false, false],
	["Wasp Douro", "Wasp", "Tsuruchi", false, false, false],
	["Wasp Shaiga", "Wasp", "Tsuruchi", false, false, false],
...
const FAMILY_SEAT_PROVINCES: Dictionary = {
	...
	"Yoritomo": "Gotai",
	# Minor clans
	"Kitsune": "Fox Clan Lands",
	"Tsuruchi": "Wasp Ashinagabachi",
...
static func _create_clan_data(provinces: Dictionary) -> Dictionary:
	...
	for minor: String in ["Mantis", "Fox", "Wasp", "Centipede", "Badger",
			"Dragonfly", "Hare", "Monkey", "Ox", "Sparrow", "Tortoise"]:
		var cd := ClanData.new()
		cd.clan_name = minor
...
const ADJACENCY_TABLE: Dictionary = {
	...
	"Kosaten": ["Takuetsu", "Nanhan", "Azuma", "Heigen", "Kaeru"],
	"Hayaku": ["Nanhan", "Kazenmuketsu", "Oyomesan"],
	"Sabishii": ["Ichigun", "Kougen"],  # Crane Sabishii
	"Ichigun": ["Anshin", "Sabishii"],
	"Kazenmuketsu": ["Hayaku", "Oyomesan"],
	"Oyomesan": ["Kazenmuketsu", "Hayaku", "Gyousha"],
	"Itoshii": ["Kishou", "Umoeru", "Kougen"],
	"Umoeru": ["Itoshii", "Sabishii", "Kougen"],
	"Kougen": ["Itoshii", "Umoeru", "Sabishii"],
	"Takuetsu": ["Nanhan", "Kaeru", "Kosaten"],
	"Nanhan": ["Takuetsu", "Hayaku", "Kosaten"],
	"Gyousha": ["Oyomesan", "Kishou"],
	"Kishou": ["Gyousha", "Itoshii"],

	# --- Dragon ---
	"Shinpi": ["Kaitou", "Gaien", "Yakeishi"],
	"Kaitou": ["Shinpi", "Yakeishi", "Sinjutsu"],
	"Sinjutsu": ["Kaitou"],
	"Gaien": ["Shinpi", "Sabishii_Dragon"],
	"Yakeishi": ["Shinpi", "Kaitou", "Kinenkan", "Toshibu"],
	"Toshibu": ["Yakeishi", "Kousou"],
	"Kousou": ["Toshibu", "Mucha", "Kinenkan"],
	"Sabishii_Dragon": ["Gaien", "Mucha"],
	"Kinenkan": ["Yakeishi", "Kousou", "Toshibu", "Mucha"],
	"Mucha": ["Kousou", "Kinenkan", "Sabishii_Dragon"],

	# --- Phoenix ---
	"En-Ju": ["Yosomono", "Aoijiroi", "Kyuukai", "Ki-Rin"],
	"Ki-Rin": ["En-Ju", "Kyuukai"],
	...
	"Omoidasu": ["Mihari", "Nanimo", "Haimaato"],
	"Haimaato": ["Omoidasu", "Nanimo"],
	"Enjaku": ["Anshin_Phoenix", "Nanimo", "Ukabu", "Kyuukai", "Yogen"],
	...
	"Yosomono": ["En-Ju", "Kougen_Phoenix", "Aoijiroi"],
	"Kougen_Phoenix": ["Yosomono", "Aoijiroi", "Kinkaku", "Maryoku"],
	"Garanto_Phoenix": ["Maryoku", "Kinkaku"],
	"Aoijiroi": ["En-Ju", "Yosomono", "Kyuukai", "Kougen_Phoenix", "Yogen", "Nejiro"],
	...
	"Kokoro": ["Oiku", "Henkyou", "Ken-ryu", "Renga"],
	"Oiku": ["Henkyou", "Kokoro", "Hayai", "Rugashi"],
	...
	"Hayai": ["Eiyu", "Ikota", "Dairiki", "Rugashi", "Oiku"],
	"Rugashi": ["Oiku", "Henkyou", "Foshi", "Dairiki", "Hayai"],
	"Azuma": ["Heigen", "Kosaten"],
	"Chuugen": ["Gunsho", "Dairiki", "Gakka"],
	"Gakka": ["Chuugen", "Dairiki", "Foshi", "Heigen"],
	"Heigen": ["Gakka", "Tonfajutsen", "Kaeru", "Kosaten", "Azuma"],
	...
	"Nezuban": ["Beiden", "Chuuou"],
	"Chuuou": ["Beiden", "Nezuban", "Hizoku", "Kunizakai"],
	...
	"Kouryo": ["Haisho", "Aishou", "Bugaisha", "Manaka", "Tsuriai", "Senseki"],
	"Isei": ["Bugaisha", "Garanto_Unicorn", "Zenzan", "Kawabe", "Manaka"],
	"Koubaku": ["Senseki", "Tsuriai", "Ikoku", "Sabishii_Dragon"],
	"Manaka": ["Tsuriai", "Kouryo", "Ikoku", "Kawabe", "Zenzan", "Isei", "Bugaisha"],
	...
	# --- Minor Clans ---
	"Fox Clan Lands": ["Kougen", "Sabishii", "Ichigun"],
	"Wasp Ashinagabachi": ["Wasp Enzan", "Nezuban", "Wasp Chuuhan", "Wasp Douro", "Oyomesan"],
	"Wasp Enzan": ["Wasp Ashinagabachi", "Oyomesan"],
	"Wasp Chuuhan": ["Chuuou", "Wasp Ashinagabachi", "Wasp Douro"],
	"Wasp Douro": ["Wasp Chuuhan", "Wasp Ashinagabachi", "Wasp Shaiga", "Gyousha", "Kishou"],
	"Wasp Shaiga": ["Wasp Douro", "Kougen", "Itoshii"],
	"Valley of the Centipede": ["Omoidasu"],
	"Badger Clan Lands": ["Kouryo"],
	"Dragonfly Clan Lands": ["Kaitou", "Shinpi", "Sinjutsu", "Oiku", "Hayai"],
	"Hare Clan Lands": ["Fox Clan Lands"],
	"Monkey Clan Lands": ["Gakka", "Heigen", "Azuma", "Yama"],
	"Ox Clan Lands": ["Toshibu", "En-Ju", "Ki-Rin", "Yosomono"],
	"Sparrow Clan Lands": ["Fox Clan Lands", "Ishibei"],
	"Tortoise Clan Lands": [],

	# --- Imperial ---
	"Toshi Ranbo": ["Enjaku", "Kokoro", "Oiku"],
}
