...
static func terrain_cost(tile: int) -> int:
	match tile:
		Enums.TileType.VOID, Enums.TileType.WALL_STONE, Enums.TileType.WALL_WOOD, Enums.TileType.WALL_PAPER, Enums.TileType.WATER_DEEP, Enums.TileType.TREE_EVERGREEN, Enums.TileType.TREE_DECIDUOUS, Enums.TileType.TREE_CHERRY, Enums.TileType.TREE_DEAD, Enums.TileType.BAMBOO, Enums.TileType.DOOR_SHOJI_CLOSED, Enums.TileType.DOOR_WOOD_CLOSED, Enums.TileType.GATE_CLOSED, Enums.TileType.FURNITURE_HEARTH, Enums.TileType.FURNITURE_CHEST, Enums.TileType.FURNITURE_TABLE, Enums.TileType.FURNITURE_JAR, Enums.TileType.FURNITURE_BRAZIER:
			return 0
