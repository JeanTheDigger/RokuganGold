...
**PROVISIONAL:** *Encirclement Morale damage: automatic 10 per round, bypassing Morale Defense entirely. Peasant Levy (Morale 8) destroyed in 1 round, Bushi Retainer (18) in 2, Lion’s Pride (22) in 3. Deathseekers immune. Value PROVISIONAL.*
...
- Crab and Lion clan armies receive bonuses to storm assaults due to their siege engineering traditions (Kaiu engineers). Clan advantages in siege warfare emerge from school techniques (e.g., Kaiu Engineer siege abilities) rather than a separate clan-level bonus system.
...
- Personality modifier: aggressive lords feel the shame sooner (threshold reduced to 20 daily ticks). Pragmatic lords (Crab, Scorpion) feel it later (threshold extended to 45 daily ticks). Values PROVISIONAL.
...
- Separate design session required. Taint exposure, no foraging possible, Crab-specific bonuses, and supernatural threats make this terrain a fundamentally different system from standard terrain modifiers.
