...
func _on_connected_for_character_creation():
	...
	var character_creation_scene = load("res://scenes/character_creation.tscn")
...
func _start_storyteller_mode_final():
	...
	var main_scene: Control = load("res://scenes/main_ui.tscn").instantiate()
