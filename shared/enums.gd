...
enum Advantage {
	...
	FORBIDDEN_KNOWLEDGE,
	FRIENDLY_KAMI,
	FRIEND_OF_THE_BROTHERHOOD,
	FRIEND_OF_THE_ELEMENTS,
	GAIJIN_GEAR,
	GENTRY,
	GREAT_DESTINY,
	GREAT_POTENTIAL,
	...
	IMPERIAL_SPOUSE,
	INHERITANCE,
	INHERITANCE_ASAHINA_BLADE,
	INHERITANCE_KOBUNE,
	INHERITANCE_TRAINED_FALCON,
	INHERITANCE_WATER_HAMMER_ARMOR,
	INNER_GIFT,
	IRREPROACHABLE,
	ISHIKEN_DO,
	LANGUAGES,
	...
	SACROSANCT,
	SAGE,
	SAGE_OF_SWORD_AND_FAN,
	SENSATION,
	SERVANT,
	SEVEN_FORTUNES_BLESSING,
	SHADOWED_HEART,
	SILENT,
	SOCIAL_POSITION,
	SOUL_OF_ARTISTRY,
...
enum ShadowlandsPowerTier {
	MINOR = 0,
	MAJOR = 1,
	AKUTENSHI = 2,
}

enum ShadowlandsPowerType {
	NONE = 0,
	# Minor (16)
	ABOVE_THE_ELEMENTS,
	BLACKENED_CLAWS,
	BLESSING_OF_THE_DARK_ONE,
	BLOOD_KNOWS_BLOOD,
	CALLIGRAPHY_OF_THOUGHT,
	CHILD_OF_DARKNESS,
	EYES_OF_HELL,
	FEAR_POWER,
	JADE_SENSE,
	...
	CHOSEN_OF_FU_LENG,
	DISRUPT_THE_CHI,
	DRAWING_OUT_THE_DARKNESS,
	EVADE_THE_UNWORTHY,
	FATHER_OF_LIES,
	FEEDING_ON_FLESH,
	FLIGHT_OF_DARKNESS,
	PROTECTION_OF_THE_DARK,
	STRENGTH_OF_MADNESS,
	STRENGTH_OF_THE_DARK_ONE,
	THY_MASTERS_WILL,
	UNDEAD_STRENGTH,
	UNEARTHLY_REGENERATION,
	UNHOLY_BEAUTY,
	# Akutenshi (9) — treated as Major for activation purposes
	AWE_OF_THE_DARK_ONE,
	BODY_OF_DAMNED_TIME,
	BREATH_OF_TAINT,
	CLAIM_THE_BODY,
	MASTERY_OF_DARKNESS,
	PASSING_THROUGH_THE_LIGHT,
	SHAPESHIFTING,
	SOUL_DRINKING,
	TERROR_OF_FU_LENG,
}
