...
_BROTHERHOOD_TABLE: dict = {
    ...
    "shameful": [
        {
            "rolls": [1],
            "effect": "Your master was a heretic who was devoted to a False Path rather than to following the Tao or the Fortunes. As a result, your own teachings are fatally skewed. You must take the Consumed Disadvantage.",
            "grants": {"disadvantages": ["Consumed"]},
            "notes": ["Fortune determines the specific form of the Consumed Disadvantage."],
        },
        {
            "rolls": [2, 3],
            "effect": "The shrine or temple where you were trained was in an exceptionally impoverished area of the Empire. You begin play with the Ascetic Disadvantage for no points.",
            "grants": {"disadvantages": ["Ascetic"]},
        },
        {
            "rolls": [4, 5],
            "effect": "Your temple teaches that everyone should always question the world at all times in order to have any chance of Enlightenment. You gain the Contrary Disadvantage for no points.",
            "grants": {"disadvantages": ["Contrary"]},
        },
        {
            "rolls": [6, 7],
            "effect": "The temple in which you were trained is home to monks who have little true piety and often engage in improper behavior. Many of them do not really follow the Tao or the Fortunes at all. You gain either the Disbeliever Disadvantage or the Infamy Disadvantage (your choice) for no points.",
            "grants": {},
            "notes": ["Choose either the Disbeliever or the Infamy Disadvantage (for no points)."],
        },
        {
            "rolls": [8, 9],
            "effect": "The temple where you were trained teaches obsessive self-reliance above all else. You gain the Overconfident Disadvantage for no points.",
            "grants": {"disadvantages": ["Overconfident"]},
        },
        {
            "rolls": [10],
            "effect": "Something within the temple where you were raised is tainted by darkness. Gain either 1 Rank of the Shadowlands Taint or one Shadow Rank, as chosen by the GM.",
            "grants": {},
            "notes": ["Fortune determines: Gain either 1 Rank of Shadowlands Taint or 1 Shadow Rank."],
        },
    ],
    "illustrious": [
        {
            "rolls": [1],
            "effect": "The calm of a placid lake flows through all those trained in your temple. You gain the Balance Advantage.",
            "grants": {"advantages": ["Balance"]},
        },
        {
            "rolls": [2, 3],
            "effect": "Your temple focuses on physical advancement more than on spiritual study, and thereby promotes bold actions. You gain the Daredevil Advantage.",
            "grants": {"advantages": ["Daredevil"]},
        },
        {
            "rolls": [4, 5],
            "effect": "Your temple was built on a location beloved by the spirits of a particular Element, and all monks of that temple are favored by that Element. You gain the Elemental Blessing Advantage in whichever Element your temple favors.",
            "grants": {"advantages": ["Elemental Blessing"]},
            "notes": ["Fortune determines which Element the Elemental Blessing applies to."],
        },
        {
            "rolls": [6, 7],
            "effect": "Your temple has a singular martial tradition which uses a specific weapon to teach unity of body and spirit. You gain 1 free Rank in a Weapon Skill of your choice.",
            "grants": {},
            "notes": ["Gain 1 free Rank in a Weapon Skill of your choice."],
        },
        {
            "rolls": [8, 9],
            "effect": "You and your temple have protected a group of villages from harm for generations. Word of the deeds of your temple has spread among the commoners. You gain the Hero of the People Advantage.",
            "grants": {"advantages": ["Hero of the People"]},
        },
        {
            "rolls": [10],
            "effect": "You were taught by an exceptional sensei, perhaps even a descendant of Shinsei himself, and gained deep insight into the world and yourself. You may take the Enlightened Advantage for only 3 points.",
            "grants": {},
            "notes": ["May take the Enlightened Advantage for only 3 XP (reduced cost)."],
        },
    ],
    "mixed": [
        {
            "rolls": [1],
            "effect": "Your temple is the keeper of knowledge entrusted to it by a powerful samurai, perhaps even the Emperor himself. You gain the Forbidden Knowledge Advantage and a 3-point Obligation to the samurai who entrusted the information to your temple.",
            "grants": {"advantages": ["Forbidden Knowledge"], "disadvantages": ["Obligation (3 points)"]},
            "notes": ["Fortune determines the nature of the Forbidden Knowledge and who holds the Obligation."],
        },
        {
            "rolls": [2, 3],
            "effect": "Your temple is known to be far more worldly than it should. You gain the Infamous Disadvantage, but add 2 koku to your Outfit.",
            "grants": {"koku": 2, "disadvantages": ["Infamous"]},
        },
        {
            "rolls": [4, 5],
            "effect": "The temple where you were trained focused upon individual study of the Tao above all else, including human contact. You gain the Sage Advantage but also a 2-point Antisocial Disadvantage.",
            "grants": {"advantages": ["Sage"], "disadvantages": ["Antisocial (2 points)"]},
        },
        {
            "rolls": [6, 7],
            "effect": "One of the Fortunes smiles upon your temple, but this has caused the monks there to focus solely upon the things that Fortune finds important. You gain either the Seven Fortune's Blessing Advantage or the Inari's Blessing Advantage, but also gain the Driven Disadvantage in a form connected to the goals of the chosen Fortune.",
            "grants": {"disadvantages": ["Driven"]},
            "notes": ["Choose either Seven Fortune's Blessing or Inari's Blessing. Fortune determines the Driven form."],
        },
        {
            "rolls": [8, 9],
            "effect": "You were born a samurai, but were forced to join the Brotherhood before completing your gempukku. There are members of your family who are not happy about this fact. You gain the Forced Retirement Disadvantage but also gain a 3-Point Ally Advantage with someone in your former clan.",
            "grants": {"advantages": ["Ally (3 points, former clan)"], "disadvantages": ["Forced Retirement"]},
            "notes": ["Fortune determines which clan the Ally belongs to."],
        },
        {
            "rolls": [10],
            "effect": "Your sensei venerated certain moral values highly, but rejected others as unimportant. You gain the Paragon Advantage for one tenet of Bushido, but also gain the Failure of Bushido Disadvantage for a different tenet.",
            "grants": {},
            "notes": ["Choose one tenet of Bushido for the Paragon Advantage and a different tenet for the Failure of Bushido Disadvantage. This overrides normal restrictions on taking these together."],
        },
    ],
}
...
HERITAGE_TABLES: dict[str, dict] = {
    ...
    "Brotherhood": _BROTHERHOOD_TABLE,
