...
HERITAGE_TABLES: dict[str, list[dict]] = {
    "Crab": [
        {"roll": 1, "name": "Famous Deed", "effect": "Ancestor once performed a heroic defense of the Wall. +3 Glory points."},
        ...
        {"roll": 4, "name": "Tainted Past", "effect": "Ancestor fell to the Taint. Family is watched carefully. −5 Glory points, +1 Willpower for Taint resistance."},
        {"roll": 5, "name": "Siege Master", "effect": "Ancestor designed a key section of the Wall. +1 rank in Engineering (free)."},
        {"roll": 6, "name": "Dark Secret", "effect": "Ancestor used maho to defend the Wall. If discovered: −3 Honor points, −5 Glory points."},
    ...
    "Crane": [
        ...
        {"roll": 2, "name": "Political Marriage", "effect": "Family has strong political ties. +3 Status points."},
        {"roll": 3, "name": "Dueling Prodigy", "effect": "Ancestor was a famous duelist. +1 rank in Iaijutsu (free)."},
        {"roll": 4, "name": "Bitter Rival", "effect": "Family has a longstanding feud with another Crane family. −1 Glory point when interacting with that family."},
        {"roll": 5, "name": "Courtier's Grace", "effect": "Ancestor was a renowned courtier. +1 rank in Courtier (free)."},
        {"roll": 6, "name": "Scandal", "effect": "An ancestor caused a scandal. −5 Glory points, but family is resilient: +1 Willpower."},
        {"roll": 7, "name": "Imperial Favor", "effect": "Family once held Imperial favor. +5 Status points."},
    ...
    "Lion": [
        {"roll": 1, "name": "War Hero", "effect": "Ancestor was a legendary general. +3 Glory points."},
        ...
        {"roll": 4, "name": "Dishonored Ancestor", "effect": "An ancestor was stripped of honor. −5 Honor points, but character is driven: +1 Willpower."},
        ...
        {"roll": 8, "name": "Political Connections", "effect": "Family has ties to the Imperial Court. +5 Status points."},
    ...
    "Mantis": [
        ...
        {"roll": 4, "name": "Questionable Methods", "effect": "Ancestor used dishonorable tactics. −5 Honor points, but +1 rank in Commerce (free)."},
    ...
    "Phoenix": [
        ...
        {"roll": 8, "name": "Temple Holdings", "effect": "Family maintains a prominent temple. +5 Status points."},
    ...
    "Scorpion": [
        ...
        {"roll": 4, "name": "Double Agent", "effect": "Ancestor was a double agent. Family is distrusted even within Scorpion. −5 Glory points, +1 rank in Sincerity (free)."},
    ...
    "Unicorn": [
        ...
        {"roll": 4, "name": "Outsider's Perspective", "effect": "Family keeps foreign customs. −5 Honor points in traditional Rokugani eyes, +1 rank in Investigation (free)."},
...
DEFAULT_TABLE: list[dict] = [
    {"roll": 1, "name": "Noble Heritage", "effect": "+3 Glory points."},
    ...
    {"roll": 6, "name": "Political Ties", "effect": "+5 Status points."},
