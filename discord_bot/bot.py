...
_DM_WIZARD_CATS: list[tuple[str, str, str, list[tuple[str, str]]]] = [
    ...
    ("", "Creatures", "Bestiary creature management.", [
        ...
        ("/creature view", "View a spawned creature's full stat block"),
        ("/creature list", "List spawned creatures (visible to players)"),
    ...
    ("", "Combat", "Start encounters and manage combatants.", [
        ...
        ("/fight attack", "Attack (use attacker_npc to attack as an NPC)"),
        ("/creature attack", "Creature attacks a PC/NPC (fixed stat block)"),
        ("/fight stance / guard / full_defense", "Set stance or declare defense (own PC or Fortune)"),
        ("/fight mount", "Mount or dismount (own PC or Fortune)"),
        ("/fight action", "Track Simple/Complex action usage (own PC or Fortune)"),
        ("/combat void armor / initiative / swap", "Spend Void Points (own PC or Fortune)"),
...
_HELP_BLURBS: dict[str, str] = {
    ...
    "combat": "Initiative tracker: Start, join, setup, next turn, board, recap, summary. Your actions are under /fight; grapples, duels and battles under /engage.",
    "fight": "Your actions in a fight: Attack, stance, guard, full defense, mount, condition, action tracking, status card.",
    "engage": "Grapple, Iaijutsu duel and mass battle subsystems (run by Fortune).",
    "spell": "Browse spells, cast, resist, importune, interrupt, spell damage.",
