...
func test_gi_lord_strongly_cooperates():
	...
	var result := ExtraditionSystem.evaluate_extradition(lord, 0, 1.0, 4, false, false, false)
...
func test_friend_disposition_boosts_cooperation():
	...
	var result := ExtraditionSystem.evaluate_extradition(lord, 50, 1.0, 4, false, false, false)
...
func test_rival_disposition_hurts_cooperation():
	var lord := _make_lord(Enums.BushidoVirtue.YU)
	var result := ExtraditionSystem.evaluate_extradition(lord, -30, 1.0, 4, false, false, false)
...
func test_neutral_disposition_no_effect():
	var lord := _make_lord(Enums.BushidoVirtue.YU)
	var result := ExtraditionSystem.evaluate_extradition(lord, 10, 1.0, 4, false, false, false)
...
func test_maho_tier_1_massive_pressure():
	var lord := _make_lord(Enums.BushidoVirtue.YU)
	var result := ExtraditionSystem.evaluate_extradition(lord, 0, 1.0, 1, false, false, false)
...
func test_high_status_fugitive_hard_to_hide():
	var lord := _make_lord(Enums.BushidoVirtue.YU)
	var result := ExtraditionSystem.evaluate_extradition(lord, 0, 6.0, 4, false, false, false)
	assert_eq(result["cooperation_score"], -15, "Status 5+ = -15")


func test_mid_status_fugitive():
	var lord := _make_lord(Enums.BushidoVirtue.YU)
	var result := ExtraditionSystem.evaluate_extradition(lord, 0, 4.0, 4, false, false, false)
...
func test_low_status_fugitive_gets_denied():
	var lord := _make_lord(Enums.BushidoVirtue.YU)
	var result := ExtraditionSystem.evaluate_extradition(lord, -20, 1.0, 4, false, false, false)
...
func test_high_status_fugitive_gets_outright_refusal():
	...
	var result := ExtraditionSystem.evaluate_extradition(lord, -20, 6.0, 4, false, false, false)
...
func test_hostile_lord_with_maho_fugitive_cooperates():
	...
	var result := ExtraditionSystem.evaluate_extradition(lord, -30, 1.0, 1, false, false, false)
	assert_false(result["cooperates"])
...
func test_meiyo_lord_friend_returns_fugitive():
	...
	var result := ExtraditionSystem.evaluate_extradition(lord, 50, 3.0, 3, false, false, false)
	assert_true(result["cooperates"])
...
func test_apply_cooperation_grants_disposition():
	...
	var result := ExtraditionSystem.apply_cooperation(lord, 99, 2)
...
func test_apply_cooperation_minor_crime_less_disposition():
	...
	var result := ExtraditionSystem.apply_cooperation(lord, 99, 4)
...
func test_can_petition_for_tier_2():
	assert_true(ExtraditionSystem.can_petition_emerald_champion(2))


func test_can_petition_for_tier_1():
	assert_true(ExtraditionSystem.can_petition_emerald_champion(1))


func test_cannot_petition_for_tier_3():
	assert_false(ExtraditionSystem.can_petition_emerald_champion(3))
